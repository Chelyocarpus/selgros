...
const translations = {
    de: {
        ...
        // Loading Messages
        loading: 'Laden...',
        initializingData: 'Daten werden initialisiert...',
        ...
        loadingRemoteData: 'Daten von GitHub werden geladen...',
        loadingProjectItems: 'Projekt-Elemente werden geladen...',
        processingMaterials: 'Materialien werden verarbeitet...',
        fetchingFromGitHub: 'Daten werden von GitHub geladen...',
        ...
        modalInitError: 'Material-Dialog ist noch nicht bereit',
        btnSave: 'Speichern',
        ...
        storageBackendTitle: 'Speicher-Backend',
        storageBackendDescription: 'Wählen Sie aus, wo Ihre Daten gespeichert und synchronisiert werden',
        dexieDescription: 'Lokaler Browser-Speicher - schnell und zuverlässig',
        githubDescription: 'Cloud-Speicher mit Echtzeit-Zusammenarbeit',
        active: 'Aktiv',
        available: 'Verfügbar',
        notConfigured: 'Nicht konfiguriert',
        
        // GitHub Configuration
        githubConfigTitle: 'GitHub Projects Konfiguration',
        githubTokenLabel: 'Personal Access Token',
        createToken: 'Token erstellen',
        githubTokenHelp: 'Erforderliche Bereiche: project (Lesen/Schreiben)',
        githubOwnerLabel: 'GitHub Benutzername oder Organisation',
        githubProjectNumberLabel: 'Projektnummer',
        githubProjectNumberHelp: 'Finden Sie diese in Ihrer Projekt-URL: github.com/users/[benutzer]/projects/[nummer]',
        btnSaveConfig: 'Speichern & Verbinden',
        btnTestConnection: 'Verbindung testen',
        btnClearConfig: 'Konfiguration löschen',
        
        // Connection Status
        configureGitHubFirst: 'Bitte konfigurieren Sie zuerst GitHub Projects',
        switchingBackend: 'Speicher-Backend wird gewechselt...',
        backendSwitched: 'Zu {0} Speicher gewechselt',
        backendSwitchError: 'Fehler beim Wechseln des Speicher-Backends',
        fillAllFields: 'Bitte füllen Sie alle erforderlichen Felder aus',
        savingConfig: 'Konfiguration wird gespeichert...',
        githubConfigSaved: 'GitHub Projects erfolgreich konfiguriert!',
        githubConfigError: 'Konfiguration gesichert, aber Verbindung fehlgeschlagen',
        testingConnection: 'Verbindung wird getestet...',
        connectionSuccess: 'Verbindung erfolgreich!',
        connectionFailed: 'Verbindung fehlgeschlagen',
        connectionError: 'Verbindungstest fehlgeschlagen',
        confirmClearGitHubConfig: 'GitHub Projects Konfiguration löschen?',
        githubConfigCleared: 'Konfiguration gelöscht',
        
        // Collaboration
        collaborationTitle: 'Echtzeit-Zusammenarbeit',
        collaborationDescription: 'Arbeiten Sie mit Ihrem Team in Echtzeit über GitHub Projects zusammen',
        collaborationActive: 'Verbunden & Synchronisiert',
        collaborationInactive: 'Nicht synchronisiert',
        enableAutoSync: 'Auto-Sync in Einstellungen aktivieren',
        syncStats: 'Sync-Statistiken',
        pendingChanges: 'Ausstehend',
        conflicts: 'Konflikte',
        apiCallsLeft: 'API-Aufrufe übrig',
        syncInterval: 'Sync-Intervall',
        lastSync: 'Letzter Sync',
        neverSynced: 'Nie',
        
        // Conflict Resolution
        resolveConflicts: 'Konflikte lösen',
        noConflicts: 'Keine Konflikte zu lösen',
        conflict: 'Konflikt',
        localVersion: 'Lokale Version',
        remoteVersion: 'Remote-Version',
        lastModified: 'Zuletzt geändert',
        useLocal: 'Lokal verwenden',
        useRemote: 'Remote verwenden',
        autoMerge: 'Auto-Merge (Neuere gewinnt)',
        conflictsDetected: 'Konflikte zwischen lokalen und Remote-Versionen erkannt. Bitte wählen Sie, welche Version beibehalten werden soll.',
        cancel: 'Abbrechen',
        useAllRemote: 'Alle Remote verwenden',
        useAllLocal: 'Alle Lokal verwenden',
        conflictResolved: 'Konflikt gelöst',
        allConflictsResolved: 'Alle Konflikte gelöst!',
        conflictResolveError: 'Fehler beim Lösen des Konflikts',
        resolvingConflicts: 'Konflikte werden gelöst...',
        syncConflictsFound: '{count} Sync-Konflikt(e) erkannt — Überprüfung erforderlich',
        conflictTypeModified: 'Bearbeitet',
        conflictTypeDeletedRemote: 'Remote gelöscht',
        conflictTypeAddedRemote: 'Remote hinzugefügt',
        conflictTypeArchiveDiverged: 'Archiv abgewichen',
        conflictKeepItem: 'Behalten',
        conflictDeleteItem: 'Löschen',
        conflictAcceptNew: 'Übernehmen',
        conflictRejectNew: 'Ablehnen',
        syncAutoResolved: '{count} Konflikt(e) automatisch gelöst',
        dataUpdatedFromTab: 'Daten von einem anderen Tab aktualisiert',
        
        // Sync Operations
        forceSync: 'Jetzt synchronisieren',
        githubNotConfigured: 'GitHub Projects nicht konfiguriert',
        syncing: 'Synchronisiere...',
        syncComplete: 'Synchronisierung erfolgreich abgeschlossen!',
        syncError: 'Synchronisierung fehlgeschlagen',
        
        // Setup Guide
        setupGuide: 'Einrichtungsanleitung',
        setupStep1: 'Erstellen Sie ein GitHub Personal Access Token mit <strong>project</strong> Berechtigung',
        setupStep2: 'Erstellen Sie ein neues GitHub Project (oder verwenden Sie ein bestehendes)',
        setupStep3: 'Geben Sie Ihre Anmeldedaten unten ein und klicken Sie auf "Speichern & Verbinden"',
        githubOwnerHelp: 'Ihr GitHub Benutzername (z.B. "octocat") oder Organisationsname',
        toggleVisibility: 'Sichtbarkeit umschalten',
        
        // Sync Settings
        githubSyncSettingsLabel: 'Sync-Einstellungen',
        githubAutoSyncLabel: 'Automatische Hintergrund-Synchronisation aktivieren',
        githubSyncIntervalLabel: 'Sync-Intervall (Sekunden)',
        githubConflictStrategyLabel: 'Konfliktlösungsstrategie',
        githubConflictStrategyHelp: 'Wie Konflikte behandelt werden, wenn zwei Personen denselben Eintrag bearbeiten',
        conflictStrategyManual: 'Manuell — jeden Konflikt einzeln prüfen',
        conflictStrategyRemoteWins: 'Remote gewinnt — Remote-Änderungen immer übernehmen',
        conflictStrategyLocalWins: 'Lokal gewinnt — lokale Änderungen immer behalten',
        conflictStrategyMerge: 'Auto-Merge — neuerer Zeitstempel gewinnt',
        confirm: 'Bestätigen',
        clearConfigWarning: 'Dies entfernt Ihren Token und Projekteinstellungen. Sie können jederzeit neu konfigurieren.',
        dismissAllWarning: 'Diese Aktion kann nicht rückgängig gemacht werden.',
        
        // Streamlined Storage UI
        primaryStorageTitle: 'Primärer Speicher',
        primaryStorageDescription: 'Wählen Sie Ihre Hauptdatenbank. Alle App-Daten (Materialien, Archiv, Gruppen) werden hier gespeichert.',
        localStorageTitle: 'Lokal (Browser)',
        cloudStorageTitle: 'Cloud (GitHub Projects)',
        tip: 'Tipp',
        storageBackendTip: 'Sie können jederzeit zwischen Speicher-Backends wechseln. Daten werden nicht automatisch migriert - verwenden Sie Export/Import zum Übertragen von Daten.',
        backupExportTitle: 'Sicherung & Export',
        backupDescription: 'Erstellen Sie Sicherungen Ihrer Daten zur Aufbewahrung oder Migration zwischen Speicher-Backends.',
        localFileBackup: 'Lokale Dateisicherung',
        gistBackupTitle: 'GitHub Gist Sicherung',
        gistBackupDescription: 'Einfache Cloud-Sicherung mit GitHub Gists. Keine Datenbank - nur für Backup/Wiederherstellung.',
        localSyncTitle: 'Lokale Synchronisation',
        localSyncDescription: 'Automatische Synchronisation zwischen Browser-Tabs und IndexedDB-Verwaltung.',
        indexedDBTitle: 'IndexedDB-Verwaltung',
        
        customFieldsMode: ' (Benutzerdefinierte Felder Modus)'
    },
    en: {
        // Header
        ...
        loadingRemoteData: 'Loading data from GitHub...',
        loadingProjectItems: 'Loading project items...',
        processingMaterials: 'Processing materials...',
        fetchingFromGitHub: 'Fetching data from GitHub...',
        ...
        modalInitError: 'Material dialog is not ready yet',
        ...
        // GitHub Projects Integration
        storageBackendTitle: 'Storage Backend',
        storageBackendDescription: 'Choose where your data is stored and synced',
        dexieDescription: 'Local browser storage - fast and reliable',
        githubDescription: 'Cloud storage with real-time collaboration',
        active: 'Active',
        available: 'Available',
        notConfigured: 'Not Configured',
        
        // GitHub Configuration
        githubConfigTitle: 'GitHub Projects Configuration',
        githubTokenLabel: 'Personal Access Token',
        createToken: 'Create Token',
        githubTokenHelp: 'Required scopes: project (read/write)',
        githubOwnerLabel: 'GitHub Username or Organization',
        githubProjectNumberLabel: 'Project Number',
        githubProjectNumberHelp: 'Find this in your project URL: github.com/users/[user]/projects/[number]',
        btnSaveConfig: 'Save & Connect',
        btnTestConnection: 'Test Connection',
        btnClearConfig: 'Clear Config',
        
        // Connection Status
        configureGitHubFirst: 'Please configure GitHub Projects first',
        switchingBackend: 'Switching storage backend...',
        backendSwitched: 'Switched to {0} storage',
        backendSwitchError: 'Failed to switch storage backend',
        fillAllFields: 'Please fill all required fields',
        savingConfig: 'Saving configuration...',
        githubConfigSaved: 'GitHub Projects configured successfully!',
        githubConfigError: 'Configuration saved but connection failed',
        testingConnection: 'Testing connection...',
        connectionSuccess: 'Connection successful!',
        connectionFailed: 'Connection failed',
        connectionError: 'Connection test failed',
        confirmClearGitHubConfig: 'Clear GitHub Projects configuration?',
        githubConfigCleared: 'Configuration cleared',
        
        // Collaboration
        collaborationTitle: 'Real-Time Collaboration',
        collaborationDescription: 'Work together with your team in real-time using GitHub Projects',
        collaborationActive: 'Connected & Syncing',
        collaborationInactive: 'Not Syncing',
        enableAutoSync: 'Enable auto-sync in settings',
        syncStats: 'Sync Statistics',
        pendingChanges: 'Pending',
        conflicts: 'Conflicts',
        apiCallsLeft: 'API Calls Left',
        ...
        autoMerge: 'Auto Merge (Newer Wins)',
        conflictsDetected: 'Conflicts detected between local and remote versions. Please choose which version to keep.',
        cancel: 'Cancel',
        ...
        conflictResolveError: 'Failed to resolve conflict',
        resolvingConflicts: 'Resolving conflicts...',
        syncConflictsFound: '{count} sync conflict(s) detected — review needed',
        conflictTypeModified: 'Modified',
        conflictTypeDeletedRemote: 'Deleted remotely',
        conflictTypeAddedRemote: 'Added remotely',
        conflictTypeArchiveDiverged: 'Archive diverged',
        conflictKeepItem: 'Keep',
        conflictDeleteItem: 'Delete',
        conflictAcceptNew: 'Accept',
        conflictRejectNew: 'Reject',
        syncAutoResolved: '{count} conflict(s) auto-resolved',
        dataUpdatedFromTab: 'Data updated from another tab',
        
        // Sync Operations
        forceSync: 'Force Sync Now',
        githubNotConfigured: 'GitHub Projects not configured',
        syncing: 'Syncing...',
        ...
        setupStep1: 'Create a GitHub Personal Access Token with <strong>project</strong> scope',
        setupStep2: 'Create a new GitHub Project (or use existing)',
        setupStep3: 'Enter your credentials below and click "Save & Connect"',
        githubOwnerHelp: 'Your GitHub username (e.g., "octocat") or organization name',
        toggleVisibility: 'Toggle Visibility',
        
        // Sync Settings
        githubSyncSettingsLabel: 'Sync Settings',
        githubAutoSyncLabel: 'Enable automatic background sync',
        githubSyncIntervalLabel: 'Sync interval (seconds)',
        githubConflictStrategyLabel: 'Conflict resolution strategy',
        githubConflictStrategyHelp: 'How to handle conflicts when two people edit the same item',
        conflictStrategyManual: 'Manual — review each conflict',
        conflictStrategyRemoteWins: 'Remote wins — always accept remote changes',
        conflictStrategyLocalWins: 'Local wins — always keep local changes',
        conflictStrategyMerge: 'Auto-merge — newer timestamp wins',
        confirm: 'Confirm',
        clearConfigWarning: 'This will remove your token and project settings. You can reconfigure anytime.',
        dismissAllWarning: 'This action cannot be undone.',
        
        // Streamlined Storage UI
        primaryStorageTitle: 'Primary Storage',
        primaryStorageDescription: 'Choose your main database. All app data (materials, archive, groups) is stored here.',
        localStorageTitle: 'Local (Browser)',
        cloudStorageTitle: 'Cloud (GitHub Projects)',
        tip: 'Tip',
        storageBackendTip: 'You can switch between storage backends anytime. Data is not automatically migrated - use Export/Import to transfer data.',
        backupExportTitle: 'Backup & Export',
        backupDescription: 'Create backups of your data for safekeeping or migration between storage backends.',
        localFileBackup: 'Local File Backup',
        gistBackupTitle: 'GitHub Gist Backup',
        gistBackupDescription: 'Simple cloud backup using GitHub Gists. Not a database - for backup/restore only.',
        localSyncTitle: 'Local Synchronization',
        localSyncDescription: 'Automatic synchronization between browser tabs and IndexedDB management.',
        indexedDBTitle: 'IndexedDB Management',
        
        customFieldsMode: ' (Custom Fields Mode)'
    }
};
